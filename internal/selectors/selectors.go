...
const MonthCalendar = ".styles-module-calendar-I_fDT"
const AvailableDate = ".styles-module-day_hoverable-_qBAt"
const Datepicker = "*[data-marker='datepicker']"
const DatepickerButton = ".datepicker-range-input-_C1z4"